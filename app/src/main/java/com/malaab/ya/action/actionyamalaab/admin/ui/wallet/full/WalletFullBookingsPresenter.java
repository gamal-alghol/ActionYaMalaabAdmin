...
public class WalletFullBookingsPresenter<V extends WalletFullBookingsMvpView>
        extends BasePresenter<V>
        implements WalletFullBookingsMvpPresenter<V> {

    private DatabaseReference mDatabase;


    @Inject
    public WalletFullBookingsPresenter(DataManager dataManager, SchedulerProvider schedulerProvider, CompositeDisposable compositeDisposable, IAnalyticsTracking iAnalyticsTracking, IFirebaseTracking iFirebaseTracking) {
        super(dataManager, schedulerProvider, compositeDisposable, iAnalyticsTracking, iFirebaseTracking);

        iAnalyticsTracking.LogEventScreen("Android - Admin - Wallet Full Bookings Screen");
        iFirebaseTracking.LogEventScreen("Android - Admin - Wallet Full Bookings Screen");
    ...
    @Override
    public void getWalletFullBookings(long startDatetime, long endDatetime) {
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.exists()) {
                            ...
                            getMvpView().onGetWalletFullBookings(bookings, total,totalBooking);
