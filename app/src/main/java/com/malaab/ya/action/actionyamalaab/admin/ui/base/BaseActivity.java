...
import com.malaab.ya.action.actionyamalaab.admin.di.component.DaggerActivityComponent;
...
import com.malaab.ya.action.actionyamalaab.admin.utils.CommonUtils;
...
public abstract class BaseActivity extends TAMBaseActivity implements MvpView, BaseFragment.Callback {
    ...
    private void showSnackBar(String message) {
        ...
        if (findViewById(R.id.cl_container) == null) {
