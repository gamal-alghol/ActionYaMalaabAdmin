...
//        TextView txt_duration;
        ...
        TextView txt_price;
        @BindView(R.id.txt_paymentStatus)
        TextView txt_paymentStatus;
        ...
        void bind(final Booking item, final int position) {
            ...
            txt_city.setText(item.playground.address_city);
...
//            txt_duration.setText(getDuration(item.duration));
            ...
            if (item.isAttended) {
                txt_paymentStatus.setText("تم الدفع");
            } else {
                txt_paymentStatus.setText("قيد الانتظار");
            }
