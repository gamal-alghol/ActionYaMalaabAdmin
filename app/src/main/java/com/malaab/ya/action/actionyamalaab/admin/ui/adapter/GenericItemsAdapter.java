...
public class GenericItemsAdapter extends BaseAdapter<GenericListItem> {


    public GenericItemsAdapter(List<GenericListItem> list) {
        super(list);
    }
    ...
    @Override
    public void onBindData(RecyclerView.ViewHolder holder, int position, GenericListItem item) {
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(final GenericListItem item, final int position) {
