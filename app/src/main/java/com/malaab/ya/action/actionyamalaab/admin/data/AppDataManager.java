...
import com.malaab.ya.action.actionyamalaab.admin.data.model.AppSettings;
import com.malaab.ya.action.actionyamalaab.admin.data.model.Counter;
import com.malaab.ya.action.actionyamalaab.admin.data.model.FirebaseSettings;
...
import com.malaab.ya.action.actionyamalaab.admin.data.model.UserFavouritePlaygrounds;
import com.malaab.ya.action.actionyamalaab.admin.data.model.UsersFavouritePlaygrounds;
...
public class AppDataManager implements DataManager {
    ...
    public void updateCurrentUserInfo(String userUid, long appUserId,
                                      ...
                                      String role,
                                      String fcmToken,
                                      int loggedInMode, boolean isActive) {
        ...
        User user = new User(new User.UserBuilder(email, password, loggedInMode)
                ...
                .withOptionalAddress1(address1)
                .withOptionalAddress2(address2)
                .withOptionalPostcode(postcode)
                .withOptionalCity(city)
                .withOptionalState(state)
                .withOptionalCountry(country)
