...
public class AttendeesActivity extends BaseActivity implements AttendeesMvpView, DatePickerDialog.OnDateSetListener {
    ...
    @Inject
    AttendeesPresenter<AttendeesMvpView> mPresenter;
    ...
    protected void initUI() {
        ...
        header_txt_title.setText(R.string.title_attendance_payment);

        Tab[] mTabs = new Tab[]{
                new Tab(TAB_INDIVIDUAL, getString(R.string.individual)) {
                    @Override
                    public Fragment getFragment() {
                        return new IndividualAttendeesFragment();
                    }
                },
                new Tab(TAB_Full, getString(R.string.full)) {
                    @Override
                    public Fragment getFragment() {
                        return new FullAttendeesFragment();
                    }
                }
        };
